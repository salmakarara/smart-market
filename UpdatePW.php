                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input type="submit" name="btnsubmit" value="Update Password" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20"/>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            ...
                                            if(isset($_POST["btnsubmit"]))
                                            {
                                               ...
                                               $db=new Database();
                                               $rs=$db->RunDML("update employee set password='".$_POST["password"]."' where empno='".$_GET["uid"]."'");
                                               if($rs="ok")
                                               {
